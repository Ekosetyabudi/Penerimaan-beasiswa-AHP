...
Public Class clsConn
    Public namaProgram As String = "SPK Beasiswa"
    Public conn As New MySqlConnection With {.ConnectionString = "server=localhost;userid=root;password=;database=penerimaan_beasiswa;Convert zero Datetime=True"}
